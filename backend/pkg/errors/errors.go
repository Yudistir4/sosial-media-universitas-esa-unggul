...
var (
	...
	ErrEmailNotFound                                    = errors.New("The email does not exist.")
	...
	ErrStudentAndLecturerStillRelatedToThisFaculty      = errors.New("Some students or lecturer are still affiliated with this faculty, please delete the user of students or lecturer first!")
	ErrStudentAndLecturerStillRelatedToThisStudyProgram = errors.New("Some students or lecturer are still affiliated with this study program, please delete the user of students or lecturer first!")
)
...
var errMap map[error]dto.ErrorResponse = map[error]dto.ErrorResponse{
	...
	ErrStudentAndLecturerStillRelatedToThisFaculty:      {HTTPErrorCode: http.StatusBadRequest, Message: ErrStudentAndLecturerStillRelatedToThisFaculty.Error()},
	ErrStudentAndLecturerStillRelatedToThisStudyProgram: {HTTPErrorCode: http.StatusBadRequest, Message: ErrStudentAndLecturerStillRelatedToThisStudyProgram.Error()},
