...
func (h *pollingHandler) DeletePolling(service service.PollingService) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		var req dto.DeletePollingByIDReq
		err := c.Bind(&req)
		...
		return httputils.SuccessResponse(c, httputils.SuccessResponseParams{
			...
			Message: "Delete polling successfully",
		})
